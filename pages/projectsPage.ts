...
export default class ProjectsPage {
  ...
  constructor(page: Page) {
    ...
    this.selectors = {
      ...
      actionButtonByProjectName: (projectName: string) =>
        page.getByRole("row", { name: `${projectName}` }).getByRole("button"),
      ...
      confirmDeleteCheckbox: page
        .locator("#delete-project-modal")
        .getByText("I understand and wish to delete this project"),
